...
<div class="manual-order-user-section form-group">
    ...
    <input type="text" id="manual-order-user" class="form-control" list="manual-order-user-list"
        placeholder="Search by name or email..." aria-label="Select user">
...
<div class="dashboard-grid">
    <div class="dashboard-main">
        <div class="search-bar">
            ...
            <input type="search" id="manual-product-search" class="form-control" placeholder="Filter by product name..."
                ...
                <?php if (!empty($p['is_available'])): ?>
                    <article class="product-card" data-product-name="<?= $e($p['name']) ?>">
                        ...
                        <div class="product-card-body">
                            ...
                            <button type="button" class="btn btn-primary add-to-cart-btn" data-product-id="<?= (int) $p['id'] ?>"
                                data-product-name="<?= $e($p['name']) ?>" data-price="<?= $e($p['price']) ?>">Add to
                                Cart</button>
                        </div>
                    </article>
                <?php endif; ?>
        ...
        <section class="order-form-section" aria-label="Order details">
            ...
            <form id="confirm-order-form" class="order-form"
                ...
                <div class="form-group">
                    ...
                    <textarea id="notes" name="notes" class="form-control" maxlength="500" rows="3"
