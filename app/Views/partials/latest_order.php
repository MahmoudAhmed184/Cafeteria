    ...
    <div class="flex gap-4 overflow-x-auto pb-4 scrollbar-hide" id="latest-order-widget" aria-label="Latest order">
        ...
        <div
            ...
            <div class="flex flex-col justify-center min-w-0">
                <h3 class="font-bold text-primary text-sm leading-tight truncate">
                    <?= $e($item['name'] ?? '')?>
                </h3>
                <p class="text-xs text-secondary font-medium mt-0.5">EGP
                    <?= $e(number_format((float)($item['price_at_time_of_order'] ?? 0), 2))?>
                </p>
